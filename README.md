...
You can download the MIND dataset and read the paper from https://msnews.github.io/. Download the training and validation set of MIND Large dataset and store it in the same directory as the 2 notebooks.
